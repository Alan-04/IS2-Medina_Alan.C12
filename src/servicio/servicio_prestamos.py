...
class ServicioPrestamos:
    ...
    def registrar_prestamo(self, socio, libro):
        ...
        # actualizar la instancia que se pasó (para que el test vea el cambio)
        ...
        try:
            ...
            # Asegurar que la relación libro está cargada en la instancia que devolvemos
            prestamo_db.libro = libro_db

            # despegar de la sesión (opcional) pero ya tenemos los atributos cargados
    ...
    def registrar_devolucion(self, prestamo):
        # Actualizar también la instancia pasada (para que el test vea el cambio)
        ...
        try:
            ...
            # asegurar que libro está cargado y devolver la instancia actualizada
            sesion.refresh(prestamo_db)
